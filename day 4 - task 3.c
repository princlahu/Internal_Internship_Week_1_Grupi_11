...
void showAnalytics(StudentRecord records[], int count)
{
    if (count == 0)
    {
    ...
    double average = (double)totalProgress / count;
    ...
    {
        printf("Class performance: متوسط / decent progress, but can improve.\n");
    }
    else
    {
        printf("Class performance: Low progress, needs more work.\n");
    }
}
