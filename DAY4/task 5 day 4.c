...
void raport(struct Regjistrim lista[], int count) {
    ...
    if (mesatarja >= 80)
        ...
        printf("Gjendja: Dobët ⚠️\n");
}

// POINTER UPDATE (KËRKESA 4)
void perditesoProgresin(struct Regjistrim *r) {

    int ri;

    printf("Progresi aktual: %d%%\n", r->progresi);
    printf("Ri progresi (0-100): ");
    scanf("%d", &ri);
